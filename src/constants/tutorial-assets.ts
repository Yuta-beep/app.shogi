...
export const tutorialAssets = {
  ...
  overlays: {
    ...
    stage: require('../../assets/tutorial/チュートリアルステージ.png'),
    light: require('../../assets/tutorial/チュートリアル光.png'),
    ...
    currency: require('../../assets/tutorial/通貨.png'),
    deckbuilder: require('../../assets/tutorial/チュートリアルデッキビルダー.png'),
    cost: require('../../assets/tutorial/チュートリアルコスト.png'),
